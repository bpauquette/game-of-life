...
describe('shapes', () => {
  ...
  describe('basic structure validation', () => {
    ...
    it('should have expected shape categories', () => {
      const expectedShapes = [
        ...
        'gliderGun', 'r_pentomino', 'acorn', 'diehard',
        'pentadecathlon', 'clock', 'glider2', 'glider3',
        'smallExploder', 'exploder', 'canoe', 'hammer',
        'tub', 'loaf', 'boat'
      ];
  ...
  describe('specific shape validation', () => {
    it('should have correct glider pattern', () => {
      expect(shapes.glider).toEqual([[1,0],[2,1],[0,2],[1,2],[2,2]]);
    });

    it('should have correct blinker pattern', () => {
      expect(shapes.blinker).toEqual([[0,0],[1,0],[2,0]]);
    });

    it('should have correct toad pattern', () => {
      expect(shapes.toad).toEqual([[1,0],[2,0],[3,0],[0,1],[1,1],[2,1]]);
    });

    it('should have correct r_pentomino pattern', () => {
      expect(shapes.r_pentomino).toEqual([[1,0],[2,0],[0,1],[1,1],[1,2]]);
    });

    it('should have correct tub pattern', () => {
      expect(shapes.tub).toEqual([[1,0],[0,1],[2,1],[1,2]]);
    });
  });
  ...
  describe('oscillator patterns', () => {
    const oscillators = ['blinker', 'toad', 'beacon', 'pulsar', 'clock', 'canoe'];
