...
// Moved to src/new-tests/GameRenderer.colorScheme.test.js
// Keeping this file skipped temporarily to avoid duplicate executions until cleanup.
describe.skip('GameRenderer colorScheme switching', () => {
