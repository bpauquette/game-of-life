...
describe("RecentShapesStrip", () => {
  ...
  describe("Rendering", () => {
    ...
    test("renders correct number of SVG elements", () => {
      const { container } = render(
        <RecentShapesStrip {...defaultProps} recentShapes={mockShapes} />,
      );
  ...
  describe("Cell Handling", () => {
    test("handles object-style cells", () => {
      ...
      const { container } = render(
        <RecentShapesStrip
          {...defaultProps}
          recentShapes={shapeWithObjectCells}
        />,
      );

      // Check that a cell rect is rendered
      const cellRects = container.querySelectorAll(
    ...
    test("handles array-style cells", () => {
      ...
      const { container } = render(
        <RecentShapesStrip
          {...defaultProps}
          recentShapes={shapeWithArrayCells}
        />,
      );
    ...
    test("handles shape as array directly", () => {
      ...
      const { container } = render(
        <RecentShapesStrip {...defaultProps} recentShapes={shapesAsArrays} />,
      );
    ...
    test("handles empty cells gracefully", () => {
      ...
      const { container } = render(
        <RecentShapesStrip
          {...defaultProps}
          recentShapes={shapeWithEmptyCells}
        />,
      );
  ...
  describe("Shape Dimensions", () => {
    test("calculates correct dimensions for object cells", () => {
      ...
      const { container } = render(
        <RecentShapesStrip {...defaultProps} recentShapes={shapeWith3x3} />,
      );
    ...
    test("calculates correct dimensions for array cells", () => {
      ...
      const { container } = render(
        <RecentShapesStrip {...defaultProps} recentShapes={shapeWith4x2} />,
      );
    ...
    test("handles missing coordinates gracefully", () => {
      ...
      const { container } = render(
        <RecentShapesStrip
          {...defaultProps}
          recentShapes={shapeWithMissingCoords}
        />,
      );
  ...
  describe("Shape Titles", () => {
    ...
    test("uses meta.name when shape.name not available", () => {
      ...
      render(
        <RecentShapesStrip
          {...defaultProps}
          recentShapes={shapeWithMetaName}
        />,
      );
    ...
    test("uses shape id as fallback title", () => {
      ...
      render(
        <RecentShapesStrip {...defaultProps} recentShapes={shapeWithIdOnly} />,
      );
    ...
    test("uses index-based title as final fallback", () => {
      ...
      render(
        <RecentShapesStrip
          {...defaultProps}
          recentShapes={shapeWithNoIdentifier}
        />,
      );
  ...
  describe("Edge Cases", () => {
    test("handles null shape gracefully", () => {
      ...
      render(
        <RecentShapesStrip {...defaultProps} recentShapes={shapesWithNull} />,
      );
    ...
    test("handles undefined recentShapes", () => {
      const { container } = render(
        <RecentShapesStrip {...defaultProps} recentShapes={undefined} />,
      );
    ...
    test("handles shapes with no cells property", () => {
      ...
      render(
        <RecentShapesStrip {...defaultProps} recentShapes={shapeWithNoCells} />,
      );
  ...
  describe("Shape Positioning and Stability", () => {
    ...
    test("duplicate shapes are handled by parent logic, component renders all provided", () => {
      ...
      const { container } = render(
        <RecentShapesStrip
          {...defaultProps}
          recentShapes={shapesWithDuplicates}
        />,
      );
