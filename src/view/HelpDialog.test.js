...
describe("HelpDialog", () => {
  test("renders help dialog when open", () => {
    ...
    expect(
      screen.getByText("Conway's Game of Life - Help & Guide"),
    ).toBeInTheDocument();
  ...
  test("does not render when closed", () => {
    ...
    expect(
      screen.queryByText("Conway's Game of Life - Help & Guide"),
  ...
  test("includes links to external resources", () => {
    ...
    expect(
      screen.getByText("LifeWiki - The Ultimate Reference"),
    ).toBeInTheDocument();
    const lifewikiLink = screen.getByText(
      "https://conwaylife.com/wiki/Main_Page",
    );
    expect(lifewikiLink).toHaveAttribute(
      "href",
      "https://conwaylife.com/wiki/Main_Page",
    );
